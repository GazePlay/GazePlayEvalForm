...
export class ThemeService {
  ...
  cardTheme: string[] = ["card text-bg-dark cardDark", "card-header cardHeaderColor text-center", "explanationColor", "btn btn-secondary btnColor", "accordionDarkColor", "accordionHeaderDarkColor", "cardDark", "accordionDarkLineItem"];
  ...
  changeTheme(value: string){
    ...
    if (value == "light"){
      ...
      this.cardThemeObservable.next(["card text-bg-light cardLight", "card-header text-center", "", "btn btn-secondary", "accordionLightColor", "accordionHeaderLightColor", "cardLight", "accordionLightLineItem"]);
      ...
      this.cardThemeObservable.next(["card text-bg-dark cardDark", "card-header cardHeaderColor text-center", "explanationColor", "btn btn-secondary btnColor", "accordionDarkColor", "accordionHeaderDarkColor", "cardDark", "accordionDarkLineItem"]);
